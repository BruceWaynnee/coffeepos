...
{{-- page title --}}
@section('dashboard_page_title', 'User Edit')
...
@section('content')
{{-- BEGIN:: User Edit --}}
<div class="edit-user-content-wrapper">
    <form id="user-form" action="{{route('user-update', ['id' => $user->id])}}" method="POST" enctype="multipart/form-data">
        @method('patch')
        @csrf
        {{-- general information --}}
        <div class="general-info-wrapper">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text"  minlength="2" maxlength="30" class="form-control" name="username" id="username" value="{{$user->username}}" required>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="custom-select" name="role" id="role" required>
                        <option value="{{$user->roles->first()->id}}" selected hidden >{{$user->roles->first()->name}}</option>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text"  minlength="2" maxlength="30" class="form-control" name="firstname" id="firstname" value="{{$user->firstname}}" required>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text"  minlength="2" maxlength="30" class="form-control" name="lastname" id="lastname" value="{{$user->lastname}}" required>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="email" minlength="6" maxlength="30" class="form-control" name="email" value="{{$user->email}}" id="email" required>
        ...
        <div class="user-btn-wrapper form-row">
            <input type="submit" class="btn btn-sm btn-outline-info mr-2" value="Update User">
            <a class="btn btn-sm btn-outline-danger" href="{{ route('user-list') }}">Cancel</a>
        </div>
    </form>
</div>
{{-- END:: User Edit --}}
