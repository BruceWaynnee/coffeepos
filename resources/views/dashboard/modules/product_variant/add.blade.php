...
{{-- page title --}}
{{-- @section('dashboard_page_title', 'Product Variant Add') --}}
@section('dashboard_page_title')
    Add Product Variant Of [ {{ ucwords($product->name) }} ] 
@endsection
...
@section('content')
{{-- BEGIN:: Product Variant Add --}}
<div class="add-product-variant-content-wrapper">
    <form id="product-variant-form" action="{{ url('dashboard/productvariants/create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        {{-- general information --}}
