<?php $__env->startSection('dashboard_page_title', 'Type Edit'); ?>
...
<div class="edit-type-content-wrapper">
    <form id="type-form" action="<?php echo e(route('type-update', ['id' => $type->id])); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="general-info-wrapper">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control" value="<?php echo e($type->name); ?>" type="text" minlength="2" maxlength="20" name="name" id="name" required>
            ...
            <div class="type-btn-wrapper form-row">
                ...
                <a class="btn btn-sm btn-outline-danger" href="<?php echo e(route('type-list')); ?>">Cancel</a>
            </div>
        </div>
    </form>
</div>
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coffee_pos\resources\views/dashboard/modules/type/edit.blade.php ENDPATH**/ ?>