<?php $__env->startSection('dashboard_page_title'); ?>
    Edit Product Variant Of [ <?php echo e(ucwords($product->name)); ?> ] 
...
<div class="edit-product-variant-content-wrapper">
    <form id="product-variant-form" action="<?php echo e(route('productvariant-update', ['productId' => $product->id])); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coffee_pos\resources\views/dashboard/modules/product_variant/edit.blade.php ENDPATH**/ ?>